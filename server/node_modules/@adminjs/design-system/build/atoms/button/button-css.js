...
import { ColorVariants } from "../../theme.js";
import { cssClass, themeGet } from "../../utils/index.js";
const getColor = theme => color => theme.colors[ColorVariants[color] || 'primary100'];
const legacyButtonVariants = ['danger', 'default', 'info', 'primary', 'secondary', 'success'].reduce((acc, color) => ({
  ...acc,
  [color]: {
