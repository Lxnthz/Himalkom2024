  ...
  return (
    <div>
      ...
      <div className="absolut sm:h-[28rem] lg:h-[37rem] grid grid-cols-1 grid-rows-1 border-t-4 border-b-4 border-black mt-2 ">          
        ...
        <div className="col-start-1 row-start-1 flex  h-[33rem] pt-[19rem]  md:pt-[3rem] md:m-0 md:text-left md:ml-[15rem] md:px-[4rem] lg:ml-[17rem] lg:px-[8rem] md:mt-[5rem] lg:mt-[8rem]  xl:ml-[28rem] xl:mt-[9rem] xl:px-[7rem]">
