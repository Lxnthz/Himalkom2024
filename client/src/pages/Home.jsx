    ...
    <section className="flex flex-col justify-center items-center mt-2 m-0 p-0">
      ...
      <section className="flex justify-center items-center w-[105%] bg-hero-banner-phone bg-center bg-stretch bg-no-repeat md:bg-hero-banner-tablet lg:bg-hero-banner-desktop">
        <div className="flex flex-col justify-center items-center text-center max-w-[700px] max-h-[700px] my-12 md:h-[40vw]">
          ...
          <p className="text-[12px] md:text-xl md:mt-6 lg:text-2xl xl:text-3xl font-changa">
      ...
      <section>
        ...
        <div className="bg-ilkomunity-box bg-cover bg-no-repeat bg-bottom h-fit items-center flex flex-col pt-5 w-screen">
          ...
          <section className="grid grid-cols-2 lg:grid-cols-4 md:gap-6 gap-3 p-3 place-items-center w-full max-w-[320px] md:max-w-full">
            <div
              className="bg-grid-ilkomunity bg-center bg-contain bg-no-repeat flex flex-col items-center justify-center p-6 w-full 
                                        md:h-[250px]">
              <img
                src={saungdesain}
                alt="Saung Desain"
                className="w-[60px] h-[60px] md:w-full md:h-[140px] lg:h-[100px]"
              />
        ...
        <div className="bg-megaproker-box bg-cover bg-no-repeat bg-bottom h-[1200px] md:h-[1100px] items-center flex flex-col pt-5 w-screen">
          <h1 className="font-sports text-2xl md:text-3xl mb-6">MEGAPROKER</h1>
          {/* ITod */}
          <div
            className="relative flex flex-col px-7 w-[280px] mx-5 min-w-[10rem] min-h-[672px] h-fit bg-no-repeat bg-center bg-cover bg-card-top-mobile
                                    md:max-h-[50vh] md:h-[660px] md:min-w-[43rem] md:bg-card-top-tablet md:w-[688px] md:m-0 md:p-0 
                                    lg:bg-card-top-desktop lg:bg-contain lg:bg-top lg:min-w-[1000px]">
            <div
              className="flex-grow flex flex-col justify-start relative mt-10 
                                        md:mt-[50px] md:flex-row md:justify-around md:items-start
                                        lg:mt-12">
              <div className="flex justify-center items-center mt-10 md:items-start md:mt-6">
                <img
                  src={ittoday}
                  className="w-[250px] md:w-[350px] items-center justify-center"
                  alt="IT Today"
                />
              </div>
              <div className="mt-5 flex justify-center flex-col items-center md:justify-center md:m-0">
                <h2 className="font-sports">IT TODAY</h2>
                <p className="text-justify text-xs pb-[200px] max-w-[240px] md:text-[16px] md:leading-5 lg:max-w-[400px] font-monts">
          ...
          {/* CPSC */}
          <div
            className="bg-card-bottom-mobile bg-stretch bg-no-repeat md:bg-card-bottom-tablet md:max-h-[50vh] md:h-[660px] md:min-w-[43rem]
                                    ...
                                    lg:bg-card-bottom-desktop lg:bg-contain lg:bg-top lg:min-w-[1000px]">
            <div
              className="flex-grow w-full flex flex-col justify-start relative md:flex-row-reverse md:justify-around md:items-start pt-[150px] mt-6 md:mt-[150px]
                                        lg:mt-0 lg:pt-[120px]">
              <div className=" flex flex-col justify-start items-center relative md:justify-around md:items-start mt-[100px] md:m-0">
                <img src={cpsc} className="w-[170px] md:w-[250px]" />
              </div>
              <div className="mt-5 flex justify-center flex-col items-center md:justify-center md:m-0 lg:mt-5">
                <h2 className="font-sports">CPSC</h2>
                <p className="text-justify text-xs max-w-[240px] md:text-[16px] md:leading-5 lg:max-w-[400px]  font-monts">
