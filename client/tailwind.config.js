  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'komnews-banner': "url('./src/assets/Komnews/komnews-banner.svg')",
        'komnews-headline': "url('./src/assets/Komnews/komnews-headline.svg')",
        'komnews-dalem': "url('./src/assets/Komnews/komnews-dalem.svg')",
        'komnews-card': "url('./src/assets/Komnews/komnews-card.svg')",
